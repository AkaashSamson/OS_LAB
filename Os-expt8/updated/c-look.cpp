...
int n, req_seq[MAX], current_head, traversal[MAX + 1], ub,prev_hd;
char direction;
...
int c_look(const int req_seq[], int n, int current_head, char direction, int traversal[], int &index)
{
...
int main()
{
    ...
    int total_head_movement = c_look(req_seq, n, current_head, direction, traversal, index);
