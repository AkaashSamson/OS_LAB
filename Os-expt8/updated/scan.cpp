...
int scan(const int req_seq[], int n, int current_head, char direction, int traversal[], int &index)
{
    ...
    // Add current head to the opposite direction's array
...
int main()
{
    ...
    int total_head_movement = scan(req_seq, n, current_head, direction, traversal, index);
